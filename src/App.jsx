...
function PokemonCard({ p, selected, onSelect }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 11, color: region.accent, fontWeight: 500, opacity: 0.8 }}>
        {p.habitat}
      </div>
    </div>
  );
      ...
      <div style={containerOuter}>
        <div
          style={{
            ...
            padding: 28,
            paddingBottom: isMobile ? 28 + safeArea.bottom : 28,
        ...
        >
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div style={{
              ...
              <InfoCell label="Habitat" value={p.habitat} accent={region.accent} />
...
export default function App() {
  ...
  const root = {
    ...
    color: '#fff',
    paddingTop: `calc(24px + ${safeArea.top}px)`,
    paddingBottom: `calc(40px + ${safeArea.bottom}px)`,
    paddingLeft: `calc(${isMobile ? 16 : 32}px + ${safeArea.left}px)`,
    paddingRight: `calc(${isMobile ? 16 : 32}px + ${safeArea.right}px)`,
