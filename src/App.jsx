...
/* ---------- pokémon data (230 entries across 5 regions) ----------
...
const POKEMON = [
  ...
  { id: 146, name: 'Charizard',  type: ['Fire', 'Flying'],   region: 'Withered Wasteland', habitats: ['Mountain Peak', 'Campfire Ring'], specialty: 'Fly',      time: 'Day',     weather: 'Sunny',  desc: 'Soars on broad wings over the cracked plateau. Its updrafts ferry small helpers between distant dunes.' },
  { id: 147, name: 'Camerupt',   type: ['Fire', 'Ground'],   region: 'Withered Wasteland', habitats: ['Mountain Cave', 'Campfire Ring'], specialty: 'Burn',     time: 'Any',     weather: 'Sunny',  desc: 'Carries two small volcanoes on its back. They keep entire campsites warm through cold desert nights.' },
  { id: 148, name: 'Vibrava',    type: ['Ground', 'Dragon'], region: 'Withered Wasteland', habitats: ['Boulder Tall Grass'],   specialty: 'Bulldoze', time: 'Day',     weather: 'Sunny',  desc: 'Buzzes through the heat haze on filmy wings. Its hum knocks loose dust from cracked stone.' },
  { id: 149, name: 'Flygon',     type: ['Ground', 'Dragon'], region: 'Withered Wasteland', habitats: ['Boulder Tall Grass', 'Mountain Peak'], specialty: 'Fly',      time: 'Day',     weather: 'Sunny',  desc: 'A graceful desert dragon whose wings sing in flight. It guides caravans through sandstorms.' },
  { id: 150, name: 'Sandslash',  type: ['Ground'],           region: 'Withered Wasteland', habitats: ['Tall Grass'],           specialty: 'Bulldoze', time: 'Day',     weather: 'Sunny',  desc: 'Curls into a spiny ball to roll downhill. Its quills aerate hard-packed soil wherever it lands.' },
  { id: 151, name: 'Marowak',    type: ['Ground'],           region: 'Withered Wasteland', habitats: ['Wildflower Patch'],     specialty: 'Build',    time: 'Night',   weather: 'Any',    desc: 'Carries a sturdy bone like a builder’s tool. It taps fence posts deep into desert soil at dusk.' },
  { id: 152, name: 'Krokorok',   type: ['Ground', 'Dark'],   region: 'Withered Wasteland', habitats: ['Tall Grass'],           specialty: 'Search',   time: 'Day',     weather: 'Sunny',  desc: 'Watches passing travelers from behind dark eye-stripes. It noses out buried tools without breaking stride.' },
  { id: 153, name: 'Krookodile', type: ['Ground', 'Dark'],   region: 'Withered Wasteland', habitats: ['Boulder Tall Grass'],   specialty: 'Bulldoze', time: 'Day',     weather: 'Sunny',  desc: 'A fearsome bouncer of the dune trails. Its tail-sweep flattens an entire stretch of wasteland in seconds.' },
  { id: 154, name: 'Cacturne',   type: ['Grass', 'Dark'],    region: 'Withered Wasteland', habitats: ['Wildflower Patch'],     specialty: 'Grow',     time: 'Night',   weather: 'Any',    desc: 'A spiny scarecrow that wanders by moonlight. It plants seeds in spots no helper would ever think to try.' },
  { id: 155, name: 'Excadrill',  type: ['Ground', 'Steel'],  region: 'Withered Wasteland', habitats: ['Construction Site', 'Mountain Cave'], specialty: 'Build',    time: 'Day',     weather: 'Any',    desc: 'Drills through hardpan like wet sand. Its tunnels become foundation trenches for the next outpost.' },
  { id: 156, name: 'Heliolisk',  type: ['Electric', 'Normal'], region: 'Withered Wasteland', habitats: ['Wildflower Patch'],   specialty: 'Generate', time: 'Day',     weather: 'Sunny',  desc: 'Fans a frill of solar collectors wide. A single afternoon of sun powers an irrigation pump for a week.' },
  { id: 157, name: 'Ninetales',  type: ['Fire'],             region: 'Withered Wasteland', habitats: ['Tall Grass', 'Campfire Ring'], specialty: 'Burn',     time: 'Evening', weather: 'Sunny',  desc: 'Threads through dry grass with nine flickering tails. It scorches deadwood without ever lighting the surroundings.' },
  { id: 158, name: 'Arcanine',   type: ['Fire'],             region: 'Withered Wasteland', habitats: ['Campfire Ring', 'Tall Grass'], specialty: 'Burn',     time: 'Any',     weather: 'Any',    desc: 'A noble bonfire-guardian who runs night patrols. Its very presence keeps the embers from going out.' },
  { id: 159, name: 'Darmanitan', type: ['Fire'],             region: 'Withered Wasteland', habitats: ['Campfire Ring'],        specialty: 'Burn',     time: 'Day',     weather: 'Sunny',  desc: 'Sits like a stone statue until something interesting happens. Then it lights up the whole campfire with a single roar.' },
  { id: 160, name: 'Magcargo',   type: ['Fire', 'Rock'],     region: 'Withered Wasteland', habitats: ['Mountain Cave'],        specialty: 'Burn',     time: 'Any',     weather: 'Any',    desc: 'A slow-rolling lava snail trailing fresh stone behind it. Its path becomes a perfect natural walkway once cooled.' },

  // —— Rocky Ridges (evolutions & additions) ——
  { id: 161, name: 'Graveler',   type: ['Rock', 'Ground'],   region: 'Rocky Ridges',       habitats: ['Mountain Cave', 'Boulder Tall Grass'], specialty: 'Crush',    time: 'Any',     weather: 'Any',    desc: 'Rolls down the ridges in a perfect tucked ball. It pulverizes loose rubble for the road crew.' },
  { id: 162, name: 'Golem',      type: ['Rock', 'Ground'],   region: 'Rocky Ridges',       habitats: ['Mountain Cave'],        specialty: 'Crush',    time: 'Any',     weather: 'Any',    desc: 'Drops a heavy shell on stubborn boulders. They break into perfectly stackable blocks.' },
  { id: 163, name: 'Steelix',    type: ['Steel', 'Ground'],  region: 'Rocky Ridges',       habitats: ['Mountain Cave'],        specialty: 'Bulldoze', time: 'Any',     weather: 'Any',    desc: 'A train-long iron serpent that bores wide, sturdy tunnels. Its passages last for generations.' },
  { id: 164, name: 'Lairon',     type: ['Steel', 'Rock'],    region: 'Rocky Ridges',       habitats: ['Mountain Cave'],        specialty: 'Recycle',  time: 'Day',     weather: 'Cloudy', desc: 'Lives off iron ore from the deep cave walls. Its scrap leavings refine into the cleanest nuggets.' },
  { id: 165, name: 'Aggron',     type: ['Steel', 'Rock'],    region: 'Rocky Ridges',       habitats: ['Mountain Peak'],        specialty: 'Build',    time: 'Day',     weather: 'Sunny',  desc: 'A territorial steel titan that grooms its mountain. It restores fallen rocks to their proper places.' },
  { id: 166, name: 'Pupitar',    type: ['Rock', 'Ground'],   region: 'Rocky Ridges',       habitats: ['Boulder Tall Grass'],   specialty: 'Crush',    time: 'Day',     weather: 'Sunny',  desc: 'A rocketing rocky cocoon that can’t sit still. It scours away the toughest debris in a single charge.' },
  { id: 167, name: 'Tyranitar',  type: ['Rock', 'Dark'],     region: 'Rocky Ridges',       habitats: ['Mountain Peak', 'Mountain Cave'], specialty: 'Bulldoze', time: 'Any',     weather: 'Cloudy', desc: 'A storm-summoning ridge-king. Its rumble reshapes the mountainside if it has a mind to.' },
  { id: 168, name: 'Gigalith',   type: ['Rock'],             region: 'Rocky Ridges',       habitats: ['Mountain Cave'],        specialty: 'Generate', time: 'Day',     weather: 'Sunny',  desc: 'A walking crystal generator. Helpers tap its bright facets for a steady current of energy.' },
  { id: 169, name: 'Machoke',    type: ['Fighting'],         region: 'Rocky Ridges',       habitats: ['Construction Site'],    specialty: 'Build',    time: 'Day',     weather: 'Any',    desc: 'A patient mover of impossible loads. Its belt is the secret to lifting twice its weight.' },
  { id: 170, name: 'Machamp',    type: ['Fighting'],         region: 'Rocky Ridges',       habitats: ['Construction Site', 'Mountain Peak'], specialty: 'Build',    time: 'Day',     weather: 'Sunny',  desc: 'Four arms working in perfect rhythm raise a wall in minutes. It also makes a fearsome champion of arm-wrestling.' },
  { id: 171, name: 'Primeape',   type: ['Fighting'],         region: 'Rocky Ridges',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Chop',     time: 'Day',     weather: 'Cloudy', desc: 'A hot-tempered scrapper who calms only when chopping firewood. The wood pile is always tallest near its tree.' },
  { id: 172, name: 'Golbat',     type: ['Poison', 'Flying'], region: 'Rocky Ridges',       habitats: ['Mountain Cave'],        specialty: 'Search',   time: 'Night',   weather: 'Any',    desc: 'Wheels through cave corridors in chattering swarms. Its sonar maps every wall worth knowing.' },
  { id: 173, name: 'Crobat',     type: ['Poison', 'Flying'], region: 'Rocky Ridges',       habitats: ['Mountain Cave', 'Hidden Laboratory'], specialty: 'Fly',      time: 'Night',   weather: 'Any',    desc: 'Four silent wings carry it through any passage. The fastest courier between cave and lab.' },
  { id: 174, name: 'Lucario',    type: ['Fighting', 'Steel'],region: 'Rocky Ridges',       habitats: ['Mountain Peak', 'Hidden Laboratory'], specialty: 'Hype',     time: 'Day',     weather: 'Sunny',  desc: 'Reads the aura of every helper on the ridge. A nod from this one is worth a hundred cheers.' },
  { id: 175, name: 'Gurdurr',    type: ['Fighting'],         region: 'Rocky Ridges',       habitats: ['Construction Site'],    specialty: 'Build',    time: 'Day',     weather: 'Any',    desc: 'A muscle-bound bricklayer who carries a steel I-beam everywhere. Its scaffolds never wobble.' },
  { id: 176, name: 'Conkeldurr', type: ['Fighting'],         region: 'Rocky Ridges',       habitats: ['Construction Site'],    specialty: 'Build',    time: 'Day',     weather: 'Sunny',  desc: 'Twin concrete pillars in hand, it leads the master-builder crew. Every bridge it sets endures storms.' },
  { id: 177, name: 'Sudowoodo',  type: ['Rock'],             region: 'Rocky Ridges',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Gather',  time: 'Day',     weather: 'Sunny',  desc: 'A stone Pokémon disguised as a small tree. Helpers use it as a sturdy landmark in the shaded grass.' },

  // —— Bleak Beach (evolutions & additions) ——
  { id: 178, name: 'Blastoise',  type: ['Water'],            region: 'Bleak Beach',        habitats: ['Waterside Dinghy', 'Ocean Tall Grass'], specialty: 'Water',    time: 'Day',     weather: 'Sunny',  desc: 'Twin shell-cannons mist whole rows of reeds in one sweep. The dock crew uses it to scrub barnacles too.' },
  { id: 179, name: 'Swampert',   type: ['Water', 'Ground'],  region: 'Bleak Beach',        habitats: ['Waterside Tall Grass'], specialty: 'Bulldoze', time: 'Day',     weather: 'Rain',   desc: 'A mighty mudfish that reshapes whole shorelines. It dredges silty channels so seedlings drink first.' },
  { id: 180, name: 'Empoleon',   type: ['Water', 'Steel'],   region: 'Bleak Beach',        habitats: ['Waterside Dinghy', 'Ocean Tall Grass'], specialty: 'Fly',      time: 'Day',     weather: 'Cloudy', desc: 'A regal penguin admiral that leads dinghy flotillas. Its bladed flippers cut wakes through choppy water.' },
  { id: 181, name: 'Feraligatr', type: ['Water'],            region: 'Bleak Beach',        habitats: ['Waterside Tall Grass'], specialty: 'Chop',     time: 'Day',     weather: 'Sunny',  desc: 'A massive river-king with a snapping grin. Its jaws split driftwood logs into perfect kindling.' },
  { id: 182, name: 'Samurott',   type: ['Water'],            region: 'Bleak Beach',        habitats: ['Waterside Dinghy'],     specialty: 'Chop',     time: 'Day',     weather: 'Any',    desc: 'Wields twin seamitars from its hip-plates. It trims reed clearings in two clean strokes.' },
  { id: 183, name: 'Greninja',   type: ['Water', 'Dark'],    region: 'Bleak Beach',        habitats: ['Waterside Tall Grass', 'Hidden Laboratory'], specialty: 'Search',   time: 'Night',   weather: 'Rain',   desc: 'A silent ninja-frog that flits between reeds. It scouts unmapped tidepools for the survey team.' },
  { id: 184, name: 'Primarina',  type: ['Water', 'Fairy'],   region: 'Bleak Beach',        habitats: ['Ocean Tall Grass'],     specialty: 'Hype',     time: 'Night',   weather: 'Any',    desc: 'Conducts choirs of bubbles by song. Helpers gather at the shore just to listen on still nights.' },
  { id: 185, name: 'Inteleon',   type: ['Water'],            region: 'Bleak Beach',        habitats: ['Waterside Dinghy'],     specialty: 'Search',   time: 'Day',     weather: 'Sunny',  desc: 'A sharp-eyed lizard agent perched atop a high mast. It spots distant trouble before anyone else does.' },
  { id: 186, name: 'Quaquaval',  type: ['Water', 'Fighting'],region: 'Bleak Beach',        habitats: ['Waterside Dinghy'],     specialty: 'Hype',     time: 'Day',     weather: 'Sunny',  desc: 'A dazzling carnival-dancer that high-kicks across the dock. Its routines whip every onlooker into cheers.' },
  { id: 187, name: 'Sharpedo',   type: ['Water', 'Dark'],    region: 'Bleak Beach',        habitats: ['Ocean Tall Grass'],     specialty: 'Bulldoze', time: 'Night',   weather: 'Cloudy', desc: 'A torpedo-fast predator best watched from shore. Its wake bulldozes overgrown seaweed off the reef.' },

  // —— Sparkling Skylands (evolutions & additions) ——
  { id: 188, name: 'Togekiss',   type: ['Fairy', 'Flying'],  region: 'Sparkling Skylands', habitats: ['Sky Garden', 'Secret Garden'], specialty: 'Hype',     time: 'Day',     weather: 'Sunny',  desc: 'A jubilation Pokémon that arrives where helpers are happiest. Its visit blesses any new garden.' },
  { id: 189, name: 'Clefable',   type: ['Fairy'],            region: 'Sparkling Skylands', habitats: ['Secret Garden'],        specialty: 'Hype',     time: 'Night',   weather: 'Any',    desc: 'A timid moonlit dancer that prefers hidden meadows. Helpers say its giggle makes wishes come true.' },
  { id: 190, name: 'Ampharos',   type: ['Electric'],         region: 'Sparkling Skylands', habitats: ['Hidden Laboratory', 'Sky Garden'], specialty: 'Generate', time: 'Night',   weather: 'Any',    desc: 'A lighthouse on legs whose tail-beam guides night flyers. It runs the lab’s entire array on a quiet hum.' },
  { id: 191, name: 'Drifblim',   type: ['Ghost', 'Flying'],  region: 'Sparkling Skylands', habitats: ['Sky Garden'],           specialty: 'Fly',      time: 'Evening', weather: 'Cloudy', desc: 'A great balloon-ghost that ferries heavier cargo. Helpers tether it to railings when the wind is up.' },
  { id: 192, name: 'Altaria',    type: ['Dragon', 'Flying'], region: 'Sparkling Skylands', habitats: ['Sky Garden'],           specialty: 'Fly',      time: 'Day',     weather: 'Sunny',  desc: 'Floats on cloud-fluffy wings, humming a soft tune. It tours every island patch checking on the flowers.' },
  { id: 193, name: 'Staraptor',  type: ['Normal', 'Flying'], region: 'Sparkling Skylands', habitats: ['Sky Garden'],           specialty: 'Fly',      time: 'Day',     weather: 'Any',    desc: 'A daring flock-leader with a swept crest. It chases off mischievous Drifloons drifting where they shouldn’t.' },
  { id: 194, name: 'Corviknight',type: ['Flying', 'Steel'],  region: 'Sparkling Skylands', habitats: ['Sky Garden', 'Construction Site'], specialty: 'Fly',      time: 'Day',     weather: 'Any',    desc: 'A steel-feathered raven the size of a carriage. It carries beams between island work sites in its talons.' },
  { id: 195, name: 'Jumpluff',   type: ['Grass', 'Flying'],  region: 'Sparkling Skylands', habitats: ['Sky Garden'],           specialty: 'Grow',     time: 'Day',     weather: 'Sunny',  desc: 'Three fluffballs spinning on every breeze. It pollinates the entire chain of floating planters in a single afternoon.' },
  { id: 196, name: 'Metagross',  type: ['Steel', 'Psychic'], region: 'Sparkling Skylands', habitats: ['Hidden Laboratory'],    specialty: 'Build',    time: 'Any',     weather: 'Any',    desc: 'Four legs, four minds, one perfectly engineered builder. Its calculations make the trickiest sky-bridge level.' },
  { id: 197, name: 'Porygon-Z',  type: ['Normal'],           region: 'Sparkling Skylands', habitats: ['Hidden Laboratory'],    specialty: 'Generate', time: 'Any',     weather: 'Any',    desc: 'A jittery upgrade of Porygon running experimental code. It compiles new blueprints in a blink.' },
  { id: 198, name: 'Alakazam',   type: ['Psychic'],          region: 'Sparkling Skylands', habitats: ['Hidden Laboratory'],    specialty: 'Teleport', time: 'Any',     weather: 'Any',    desc: 'Holds two silver spoons and a thousand-yard stare. It teleports rare components between island labs.' },
  { id: 199, name: 'Gardevoir',  type: ['Psychic', 'Fairy'], region: 'Sparkling Skylands', habitats: ['Secret Garden'],        specialty: 'Hype',     time: 'Day',     weather: 'Sunny',  desc: 'A serene guardian who shields its chosen helpers from harm. Its presence steadies even the shyest visitors.' },
  { id: 200, name: 'Gallade',    type: ['Psychic', 'Fighting'], region: 'Sparkling Skylands', habitats: ['Secret Garden', 'Mountain Peak'], specialty: 'Chop',     time: 'Day',     weather: 'Sunny',  desc: 'A blade-armed knight of the secret garden. It clears thickets with elegant, exact strokes.' },
  { id: 201, name: 'Whimsicott', type: ['Grass', 'Fairy'],   region: 'Sparkling Skylands', habitats: ['Sky Garden'],           specialty: 'Grow',     time: 'Day',     weather: 'Sunny',  desc: 'A mischievous tumbleweed that opens windows on the breeze. It scatters cotton seeds across the meadow.' },
  { id: 202, name: 'Wigglytuff', type: ['Normal', 'Fairy'],  region: 'Sparkling Skylands', habitats: ['Sky Garden'],           specialty: 'Hype',     time: 'Any',     weather: 'Any',    desc: 'A bouncy big sister to every Jigglypuff. It runs the island sing-along better than anyone.' },

  // —— Palette Town (evolutions, Eeveelutions & additions) ——
  { id: 203, name: 'Venusaur',   type: ['Grass', 'Poison'],  region: 'Palette Town',       habitats: ['Garden Habitat', 'Tree-Shaded Tall Grass'], specialty: 'Grow',     time: 'Day',     weather: 'Sunny',  desc: 'A walking flowerbed in full bloom. Its petals release pollen that doubles the size of every nearby planter.' },
  { id: 204, name: 'Vileplume',  type: ['Grass', 'Poison'],  region: 'Palette Town',       habitats: ['Wildflower Patch'],     specialty: 'Grow',     time: 'Day',     weather: 'Sunny',  desc: 'Wears a giant red blossom like a hat. Its dance puffs spores that wake every dormant seed nearby.' },
  { id: 205, name: 'Victreebel', type: ['Grass', 'Poison'],  region: 'Palette Town',       habitats: ['Veggie Plot'],          specialty: 'Gather',   time: 'Day',     weather: 'Sunny',  desc: 'A grinning pitcher-plant that snags overripe veggies. It returns them to the compost without a fuss.' },
  { id: 206, name: 'Sunflora',   type: ['Grass'],            region: 'Palette Town',       habitats: ['Wildflower Patch'],     specialty: 'Generate', time: 'Day',     weather: 'Sunny',  desc: 'Turns to follow the sun all morning. By noon its petals have soaked up enough to power a whole shed.' },
  { id: 207, name: 'Butterfree', type: ['Bug', 'Flying'],    region: 'Palette Town',       habitats: ['Wildflower Patch', 'Tree-Shaded Tall Grass'], specialty: 'Fly',     time: 'Day',     weather: 'Sunny',  desc: 'Dusts pollen onto every flower it passes. By season’s end the meadow is twice as colorful.' },
  { id: 208, name: 'Beedrill',   type: ['Bug', 'Poison'],    region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Gather',  time: 'Day',     weather: 'Sunny',  desc: 'A buzzing yellow squadron that defends its honey-trees. Helpers leave it well alone — and get sweet rewards anyway.' },
  { id: 209, name: 'Vaporeon',   type: ['Water'],            region: 'Palette Town',       habitats: ['Waterside Tall Grass', 'Garden Habitat'], specialty: 'Water',    time: 'Day',     weather: 'Rain',   desc: 'A graceful blue Eeveelution that almost melts into water. It waters fragile flowerbeds with one cool breath.' },
  { id: 210, name: 'Jolteon',    type: ['Electric'],         region: 'Palette Town',       habitats: ['Wildflower Patch'],     specialty: 'Generate', time: 'Day',     weather: 'Sunny',  desc: 'Bristles with static and runs in lightning loops. A single sprint charges every lantern in the square.' },
  { id: 211, name: 'Flareon',    type: ['Fire'],             region: 'Palette Town',       habitats: ['Pokémon Center', 'Campfire Ring'], specialty: 'Burn',     time: 'Any',     weather: 'Any',    desc: 'A fluffy ember-tail that curls by the hearth. It keeps the Pokémon Center waiting room toasty year-round.' },
  { id: 212, name: 'Espeon',     type: ['Psychic'],          region: 'Palette Town',       habitats: ['Garden Habitat'],       specialty: 'Hype',     time: 'Day',     weather: 'Sunny',  desc: 'A sun-warm psychic Eeveelution that reads moods at a glance. Its forehead jewel glints when the weather turns.' },
  { id: 213, name: 'Umbreon',    type: ['Dark'],             region: 'Palette Town',       habitats: ['Garden Habitat'],       specialty: 'Search',   time: 'Night',   weather: 'Any',    desc: 'A moonlit Eeveelution with shining ring-marks. It patrols the garden after dark, eyes glowing softly.' },
  { id: 214, name: 'Leafeon',    type: ['Grass'],            region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Grow',     time: 'Day',     weather: 'Sunny',  desc: 'A leaf-fringed Eeveelution that smells of fresh greenery. Its tail-leaves perform photosynthesis as it naps.' },
  { id: 215, name: 'Glaceon',    type: ['Ice'],              region: 'Palette Town',       habitats: ['Hydrated Pink Tall Grass'], specialty: 'Water',   time: 'Night',   weather: 'Cloudy', desc: 'A crisp, frost-blue Eeveelution that prefers the chillier corners. Its breath etches lacy patterns on dewy blades.' },
  { id: 216, name: 'Sylveon',    type: ['Fairy'],            region: 'Palette Town',       habitats: ['Pokémon Center'],       specialty: 'Hype',     time: 'Any',     weather: 'Any',    desc: 'Wraps its ribbon-feelers around helpers it likes. The Pokémon Center waiting room is never lonely with one nearby.' },
  { id: 217, name: 'Blissey',    type: ['Normal'],           region: 'Palette Town',       habitats: ['Pokémon Center'],       specialty: 'Hype',     time: 'Any',     weather: 'Any',    desc: 'Hands out lucky eggs to weary helpers all day long. Its smile alone is half the cure.' },
  { id: 218, name: 'Frosmoth',   type: ['Ice', 'Bug'],       region: 'Palette Town',       habitats: ['Hydrated Pink Tall Grass'], specialty: 'Water',   time: 'Night',   weather: 'Cloudy', desc: 'A gentle moth that scatters cool dew with every wing-beat. Pink blossoms it visits last twice as long.' },
  { id: 219, name: 'Dubwool',    type: ['Normal'],           region: 'Palette Town',       habitats: ['Garden Habitat'],       specialty: 'Gather',   time: 'Day',     weather: 'Sunny',  desc: 'A great fluffy sheep whose wool helpers harvest by the basket. The town’s softest mulch comes from this one.' },
  { id: 220, name: 'Greedent',   type: ['Normal'],           region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Gather',  time: 'Day',     weather: 'Any',    desc: 'Cheeks stuffed past capacity with berries. The town larder’s overflow is entirely its doing.' },
  { id: 221, name: 'Bibarel',    type: ['Normal', 'Water'],  region: 'Palette Town',       habitats: ['Veggie Plot', 'Waterside Tall Grass'], specialty: 'Build',    time: 'Day',     weather: 'Any',    desc: 'A diligent beaver-builder whose dams keep the irrigation steady. It chews timber into perfect planks.' },
  { id: 222, name: 'Meganium',   type: ['Grass'],            region: 'Palette Town',       habitats: ['Garden Habitat'],       specialty: 'Hype',     time: 'Day',     weather: 'Sunny',  desc: 'Releases a sweet aroma from the petals around its neck. Even the grouchiest helpers turn calm nearby.' },
  { id: 223, name: 'Sceptile',   type: ['Grass'],            region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Chop',     time: 'Day',     weather: 'Sunny',  desc: 'A swift forest blade-runner. Its arm-leaves slice fallen logs into perfect lengths.' },
  { id: 224, name: 'Torterra',   type: ['Grass', 'Ground'],  region: 'Palette Town',       habitats: ['Garden Habitat'],       specialty: 'Grow',     time: 'Day',     weather: 'Sunny',  desc: 'Carries a whole tree-and-meadow on its back. Smaller Pokémon hitch a ride and tend to mini-gardens of their own.' },
  { id: 225, name: 'Serperior',  type: ['Grass'],            region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Grow',     time: 'Day',     weather: 'Sunny',  desc: 'A regal vine-serpent that surveys its garden in silence. Its gaze keeps every weed politely in check.' },
  { id: 226, name: 'Chesnaught', type: ['Grass', 'Fighting'],region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Build',   time: 'Day',     weather: 'Any',    desc: 'A spiky-armored knight that shoulders the heaviest beams. Its shell shrugs off falling timber.' },
  { id: 227, name: 'Decidueye',  type: ['Grass', 'Ghost'],   region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Search',  time: 'Night',   weather: 'Any',    desc: 'Looses leaf-arrows from a perfect silent stance. It marks distant trail signs for the next morning’s walkers.' },
  { id: 228, name: 'Rillaboom',  type: ['Grass'],            region: 'Palette Town',       habitats: ['Tree-Shaded Tall Grass'], specialty: 'Hype',    time: 'Day',     weather: 'Sunny',  desc: 'Drums a great log like a stage piece. Every garden plant rocks gently to its beat.' },
  { id: 229, name: 'Meowscarada',type: ['Grass', 'Dark'],    region: 'Palette Town',       habitats: ['Garden Habitat'],       specialty: 'Search',   time: 'Night',   weather: 'Cloudy', desc: 'A masked magician-cat that performs nightly slight-of-paw. Lost objects always seem to find their way back.' },
  { id: 230, name: 'Hatterene',  type: ['Psychic', 'Fairy'], region: 'Palette Town',       habitats: ['Secret Garden'],        specialty: 'Hype',     time: 'Day',     weather: 'Any',    desc: 'A silent witch of the secret garden. It tolerates noise just long enough to bless a quiet visit.' },
];
